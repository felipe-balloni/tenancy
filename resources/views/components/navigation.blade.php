<div x-data="{ open: false }">
    <div class="relative pt-6 px-4 sm:px-6 lg:px-8">
        <nav class="relative flex items-center justify-between sm:h-10 lg:justify-start"
            ...
            <div class="hidden md:block md:ml-10 md:pr-4 md:space-x-8 whitespace-nowrap">
                ...
                @if (Route::has('login'))
                    ...
                    @else
                        <a href="{{ route('login') }}"
                           class="font-medium text-gray-500 hover:text-gray-900">Log in</a>
                    @endauth
                @endif
        ...
        <div class="rounded-lg shadow-md bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
            ...
            <div class="px-2 pt-2 pb-3 space-y-1">
                ...
                @if (Route::has('login'))
                    @auth
                        <a href="{{ url('/dashboard') }}"
                           class="block w-full px-5 py-3 text-center font-medium text-indigo-600 bg-gray-50 hover:bg-gray-100">Dashboard</a>
                    @else
                        <a href="{{ route('login') }}"
